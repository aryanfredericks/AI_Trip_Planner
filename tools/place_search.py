    ...
    def _setup_tools(self) -> List:
        ...
        def search_attractions(place:str) -> str:
            ...
            try:
                ...
                tavily_result =  self.google_places_search.google_search_attractions(place)
        ...
        def search_restaurants(place:str) -> str:
            ...
            try:
                ...
                tavily_result = self.google_places_search.google_search_restaurants(place)
        ...
        def search_transportation(place:str) -> str:
            ...
            try:
                ...
                tavily_result = self.google_places_search.google_search_transportation(place)
